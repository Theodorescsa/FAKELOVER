"""
Django settings for FAKELOVER project.
...
SECRET_KEY = 'django-insecure-syu_kvfl_$&j#7_vy+jmhw&di36imtn7%b^phr*i^r^%)()pxg'
...
WSGI_APPLICATION = 'FAKELOVER.wsgi.application'
